...
<html>
	<head>
		...
		<script>
			...
			document.sId = '<%=request.getParameter("sellerId") %>';
			document.pId = '<%=request.getParameter("productId") %>';
		</script>
		...
		<script type="text/javascript" src="js/chattingBuyer.js"></script>
	...
	<body>
		<main class="content">
			<div class="container p-0">
				...
				<h1 class="h3 mb-3" id="chatTitle">Messages</h1>
