  ...
  <footer class="d-flex flex-wrap justify-content-between align-items-center py-3 my-4 border-top">
    <div class="col-md-4 d-flex align-items-center" bis_skin_checked="1">
      <a href="/" class="mb-3 me-2 mb-md-0 text-muted text-decoration-none lh-1">
        <img style="max-width: 40px; max-height: 40px;" src="<%=request.getContextPath() %>/images/logo.png">
      </a>
      <span class="mb-3 mb-md-0 text-muted">© 2023 shoppingmall, Inc</span>
    </div>
