...
<header class="py-3 mb-3 border-bottom">
	<div class="container-fluid d-grid gap-3 align-items-center" style="grid-template-columns: 1fr 2fr;">
		<div class="dropdown">
			<i class="bi bi-list d-flex align-items-center col-lg-4 mb-2 mb-lg-0 link-dark text-decoration-none" style="font-size:3em;" data-bs-toggle="dropdown" aria-expanded="false">
			</i>			
