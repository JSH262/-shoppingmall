...
<html>
	...
	<body>
		...
		<%-- 
//////////////////////////////////////////////////////////////////////////////////////////////////////////
		결제할 상품 목록을 보여준다. 품절은 나오되 품절 표시를 한다.
		--%>
		...
		<div style="width: 90%; margin:0px auto; text-align: center;">
			...
			<div id="nextButton" class="hide-node">
				...
				<span><input type="button" value="상품목록" onclick="location.href='<%=request.getContextPath() %>/product/list.jsp';"></span>				
				<span><input type="button" value="결제목록" onclick="location.href='<%=request.getContextPath() %>/product/payment/list.jsp';"></span>
			</div>
		</div>
